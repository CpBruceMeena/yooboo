...
const rules: Rule[] = [
  {
    icon: '🎯',
    title: 'GOAL',
    text: 'Be the first to empty your hand or the last player standing.',
    hex1: '#B4FF39',
    hex2: '#33B56B',
  ...
  },
  {
    icon: '🎮',
    title: 'MATCH',
    text: 'Play a card matching the color OR type of the discard pile.',
    hex1: '#00F0FF',
    hex2: '#3478F6',
  ...
  },
  {
    icon: '⚡',
    title: 'STACK',
    text: '+2 / +4 / +6 / +10 / Reverse+4 can be countered with the same card type.',
    hex1: '#FF6A00',
    hex2: '#E44747',
  ...
  },
  {
    icon: '😊',
    title: 'SMILEY',
    text: 'Next player draws until they hit the chosen color. Cannot be stacked against.',
    hex1: '#FF2E9A',
    hex2: '#7A4DFF',
  ...
  },
  {
    icon: '⊘',
    title: 'SKIP ALL',
    text: 'Skip every other player — you go again. Cannot be played during a stack.',
    hex1: '#3478F6',
    hex2: '#1a4fa8',
    bgClass: 'from-blue/20 to-blue/5',
    glow: 'shadow-[0_0_15px_rgba(52,120,246,0.3)]',
  },
  {
    icon: '🗑',
    title: 'DISCARD ALL',
    text: 'Pick a color — discard every card of that color from your hand.',
    hex1: '#F3C742',
    hex2: '#c49a20',
  ...
  },
  {
    icon: '🚫',
    title: 'ELIMINATION',
    text: 'Reach 25+ cards and you\'re out. Last one standing wins.',
    hex1: '#FF6B6B',
    hex2: '#E44747',
  ...
  },
  {
    icon: '🔄',
    title: 'COLOR FLOW',
    text: 'Action cards keep the current color. Wild/Special cards let you pick.',
    hex1: '#7A4DFF',
    hex2: '#6B21A8',
